      ...
      <section className={css.intro}>
        <div className="container">
          <h1 className={css.title}>
            Welcome to Our Beginner ESL Story Course
          </h1>
          ...
          <div className={css.content}>
            ...
            <p>
              Each story builds <strong>a semantic field</strong>  (for example: season → food →
              description, or school → shapes → colours), which supports
              long-term retention and natural language acquisition.
            </p>

            <p>
              The course follows <strong>a spiral approach</strong> : grammar and vocabulary
              reappear across stories in new contexts, helping children
              strengthen understanding without overload.
            </p>
